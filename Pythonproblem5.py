...
while True: # Make sure user enters a numeric value
        try:
                num = int( input("enter a positive integer: ")) # Ask user to enter an integer. This input will be 'num'.
        except ValueError:
                print(" That is not a positive integer, please try again") # If a non numeric value is entered, a message will be shown and program is ran again.
                continue
        if num <= 0:
